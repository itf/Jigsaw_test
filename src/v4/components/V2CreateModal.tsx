...
import { Circle, VectorSquare, Shapes } from 'lucide-react';
          ...
          <div className="flex items-center gap-3 mt-2">
            <div className="flex-1">
              ...
              <input
                ...
                min={100}
                max={4000}
                onChange={(e) => setW(Math.max(100, parseInt(e.target.value) || 100))}
                className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm font-mono"
              />
            </div>
            <div className="text-xs font-bold text-slate-500 pt-5">×</div>
            <div className="flex-1">
              ...
              <input
                ...
                min={100}
                max={4000}
                onChange={(e) => setH(Math.max(100, parseInt(e.target.value) || 100))}
                className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm font-mono"
              />
            </div>
          </div>
